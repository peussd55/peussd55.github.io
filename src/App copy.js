      ...
      projects: [
        {
          ...
          details: lang === "KOR" ? 
            [
              ...
              "혹은 고객사 내부 통합검색화면을 직접개발합니다. 주로 프론트 .jsp페이지에서 검색서버와 솔루션api를 통해 데이터를 송수신 하는 형태로 진행이됩니다.",
            ] : 
            [
              ...
              "Alternatively, directly develop the client's internal integrated search interface, typically by enabling front-end .jsp pages to send and receive data via the solution's API.",
            ],
        },
        {
          ...
          details: lang === "KOR" ?
            [
              ...
              "챗봇 서비스단(프론트+백엔드(챗봇을 제어하는 챗봇관리도구용 DB(MySQL)연동)을 개발 후  배포합니다.",
            ...
            [
              ...
              "Develop and deploy the chatbot service application (front-end and back-end), including integration with a MySQL database for the chatbot management tool.",
    ...
    details:
      lang === "KOR"
        ? [
            ...
            "빅카인즈 뉴스 데이터를 KOBERT 모델(+LLM)로 임베딩하여 유형별 분류",
            "TF-IDF·코사인유사도로 중복 기사제거",
            "RAG 기술 기반(사용자 메타정보 - 뉴스기사 임베딩벡터, 해밍 거리 유사도 계산)으로 가장 취약한 사기 유형을 진단",
